...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2016 at 11:13 PM
...
(1, 'ตำลึง', 'ตะลึงโลก', 1, '0867891234', 'tamleong@cpe.kmutt.net', '126 ถนนประชาอุทิศ แขวงบางมด เขตทุ่งครุ กรุงเทพมหาน');
...
--
ALTER TABLE `assetlocationmovement`
MODIFY `MovementNO` int(8) NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `assetpurchase`
--
ALTER TABLE `assetpurchase`
MODIFY `PurchaseID` int(8) NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `assetsold`
--
ALTER TABLE `assetsold`
MODIFY `SoldID` int(8) NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `client`
--
ALTER TABLE `client`
MODIFY `ClientID` int(8) NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `contactedcompany`
--
ALTER TABLE `contactedcompany`
MODIFY `CompanyID` int(8) NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `employee`
--
ALTER TABLE `employee`
MODIFY `EmployeeID` int(8) NULL AUTO_INCREMENT;
ALTER TABLE `vendor`
MODIFY `VendorID` int(8) NULL AUTO_INCREMENT;
--
